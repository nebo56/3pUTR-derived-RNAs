...
do
  ...
  Rscript ${PATH}scripts/get_enrichment-mean.R control.${RBP} region.${RBP} ${RBP} $OUTPUT.region.txt
...
# plot histograms
Rscript ${PATH}scripts/plot_RBP_enrichment.R $OUTPUT.region.txt $OUTPUT.region.pdf
