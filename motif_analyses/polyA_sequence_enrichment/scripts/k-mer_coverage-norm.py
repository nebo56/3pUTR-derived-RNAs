...
def get_coverage(fin_fname, fin_fname_motifs, fout_fname):
    ...
    while line:
        ...
        line = fin.readline()
    #fout.write("\nTotal Coverage: " + str(coverage_sum))
    #fout.write(str(total_coverage).replace(' ','').replace('[','').replace(']','') + ',' + str(counter))
    #fout.write("\nNumber of positions: " + str(counter))
...
'''
fin_fname_fasta = "/home/skgthab/temp/temp/sequence"
fin_fname_motifs = "/home/skgthab/temp/temp/motifs"
get_coverage(fin_fname_fasta, fin_fname_motifs)
