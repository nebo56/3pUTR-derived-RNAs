...
coverage <- read.table("../CAGE-Hs-K562-ENCSR000CJN-rep1-rep2.no_clipping.cDNA-start-sum-2min.bed-merged20nt-peaks-max-3UTR-no5utrs-flanked30.G.matrix", header=FALSE, sep=",")
colnames(coverage) <- c("coverage","motif","strand","name")
